...
double randnum();
void printout(double), writeconf(),kinetic(), force(), simulation(), integrate(),rdfsample(),berendsen();
double box, rho, set_tem;
int N, start, ind,baseunit;
double hist[maxbin];
double U, press, dt=0.005, KE, Temp, temp_init;
